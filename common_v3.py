...
#     print('Running identify_cat')
    ...
    for word_data in words_list:
        if clean(word_data[1]) in ('cp','conj','disjunct','span'):
            del(word_data)
...
def process_foreign_word(index_data,foreign_words_data,words_info,verbs_data):
    ...
    for i,foreign_word in enumerate(foreign_words_data):
        ...
        print(relation_head,index_data)
        ...
        case,postposition = preprocess_postposition_new('noun', foreign_word, words_info, main_verb)
        print(postposition,foreign_word,'ttt')
...
def process_nouns(index_data,nouns, words_info, verbs_data):
    '''
    Functionality:
        1. Make a noun tuple
    ...
    for noun in nouns:
        ...
        print(noun,'noun data')
        relation = noun[4].strip().split(':')[1]
        print(relation_head,index_data)
        print(verbs_data,'verb')
        # if int(relation_head) in index_data and relation=='k1':
...
def process_yax(index1, relation, anim, gnp,case, pronoun, words_info, main_verb, processed_pronouns, processed_indeclinables, processed_nouns):

    # print(pronoun[4],'dep')
    # ind = pronoun[4].split(':')[0]
    # val=pronoun[4].split(':')[1]
    # print(ind,index_data)
